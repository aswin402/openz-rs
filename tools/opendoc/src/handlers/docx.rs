...
pub fn to_ir(file_path: &str) -> Result<crate::ir::Document, crate::handlers::LoadError> {
    ...
    for p in doc.paragraphs() {
        ...
        if !text.is_empty() {
            ir.paragraphs
                .push(crate::ir::elements::Paragraph::new(text));
        }
    }
    ...
    for table in doc.tables() {
        ...
        ir.tables
            .push(crate::ir::elements::Table::new(headers, data));
    }
...
mod tests {
    ...
    fn test_docx_lifecycle() {
        ...
        let imgs =
            crate::handlers::extract_images_from_zip(p, out_img_dir.to_str().unwrap()).unwrap();
