...
fn main() {
  ...
  <g transform="translate(50, 80)">
    ...
    fs::write(
        assets_dir.join("architecture_diagram.svg"),
  ...
  "timeline": {
    ...
    let icon_defs = vec![
        (
            "video",
            r##"<path d="M23 7l-7 5 7 5V7z"></path><rect x="1" y="5" width="15" height="14" rx="2" ry="2"></rect>"##,
        ),
        (
            "image",
            r##"<rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><circle cx="8.5" cy="8.5" r="1.5"></circle><polyline points="21 15 16 10 5 21"></polyline>"##,
        ),
        (
            "play",
            r##"<polygon points="5 3 19 12 5 21 5 3"></polygon>"##,
        ),
        (
            "cpu",
            r##"<rect x="4" y="4" width="16" height="16" rx="2"></rect><rect x="9" y="9" width="6" height="6"></rect><path d="M9 1v3M15 1v3M9 20v3M15 20v3M20 9h3M20 15h3M1 9h3M1 15h3"></path>"##,
        ),
        (
            "sparkles",
            r##"<path d="M12 3v18M3 12h18M12 3l3 3-3 3-3-3 3-3zm-6 9l3 3-3 3-3-3 3-3zm12 0l3 3-3 3-3-3 3-3z"></path>"##,
        ),
        (
            "workflow",
            r##"<rect x="3" y="3" width="6" height="6" rx="1"></rect><rect x="15" y="15" width="6" height="6" rx="1"></rect><rect x="15" y="3" width="6" height="6" rx="1"></rect><path d="M6 9v6h9M21 9v6"></path>"##,
        ),
        (
            "chart",
            r##"<line x1="18" y1="20" x2="18" y2="10"></line><line x1="12" y1="20" x2="12" y2="4"></line><line x1="6" y1="20" x2="6" y2="14"></line>"##,
        ),
        (
            "terminal",
        ...
        (
            "database",
            r##"<ellipse cx="12" cy="5" rx="9" ry="3"></ellipse><path d="M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"></path><path d="M3 12c0 1.66 4 3 9 3s9-1.34 9-3"></path>"##,
        ),
    ];
