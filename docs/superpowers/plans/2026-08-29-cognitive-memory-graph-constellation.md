...
- [ ] **Step 1: Add focused backend response fields**
...
- [ ] **Step 2: Extend the shared TypeScript contract**
...
- [ ] **Step 3: Preserve optional fields in store normalization**
...
- [ ] **Step 2: Run the tests to verify the initial failure**
...
- [ ] **Step 1: Add deterministic space background primitives**
...
- [ ] **Step 2: Add constellation halo and degree-aware node styling**
...
- [ ] **Step 3: Add semantic relation rendering**
...
- [ ] **Step 4: Improve constellation and node selection focus**
...
- [ ] **Step 5: Keep rendering bounded and accessible**
...
- [ ] **Step 6: Run the focused graph smoke check**
...
- [ ] **Step 1: Add page-level semantic filter state**
...
- [ ] **Step 2: Apply filters without truncating source data**
...
- [ ] **Step 3: Upgrade the inspector relation rows**
...
- [ ] **Step 4: Add responsive filter and status UI**
...
- [ ] **Step 5: Add page-level loading/stale/empty states**
...
- [ ] **Step 6: Run focused tests and WebUI checks**
...
- [ ] **Step 1: Run the final focused checks**
...
- [ ] **Step 2: Scan affected UI files for prohibited fabricated data**
...
- [ ] **Step 3: Record the completed TODO item and commit documentation**
