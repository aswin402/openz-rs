...
use crate::tools::searchxyz::core::config::IndexConfig;
use crate::tools::searchxyz::core::error::SearchXyzError;
use crate::tools::searchxyz::core::extractor::ExtractedContent;
...
impl EmbeddingGenerator {
    pub fn new(config: &crate::tools::searchxyz::core::config::EmbeddingConfig) -> Result<Self, SearchXyzError> {
...
mod tests {
    ...
    async fn test_cloud_embeddings_mock() {
        ...
        // 1. Test OpenAI
        let openai_config = crate::tools::searchxyz::core::config::EmbeddingConfig {
        ...
        // 2. Test Gemini
        let gemini_config = crate::tools::searchxyz::core::config::EmbeddingConfig {
        ...
        // 3. Test Cohere
        let cohere_config = crate::tools::searchxyz::core::config::EmbeddingConfig {
