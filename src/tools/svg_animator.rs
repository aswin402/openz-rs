...
fn parse_animation(anim: &Value) -> Vec<SvgElement> {
    ...
    match anim_type {
        ...
        "pulse" => {
            ...
            let from_s = anim.get("from_scale").and_then(|v| v.as_str()).unwrap_or("1");
            let to_s = anim.get("to_scale").and_then(|v| v.as_str()).unwrap_or("1.2");
            anims.push(
        ...
        "rotate" => {
            let from = anim.get("from").and_then(|v| v.as_str()).unwrap_or("0 50 50");
            let to = anim.get("to").and_then(|v| v.as_str()).unwrap_or("360 50 50");
            anims.push(smil_animate_transform("rotate", from, to, dur, repeat, "replace"));
        }
        "translate" => {
            let from = anim.get("from").and_then(|v| v.as_str()).unwrap_or("0 0");
            let to = anim.get("to").and_then(|v| v.as_str()).unwrap_or("100 0");
            anims.push(smil_animate_transform("translate", from, to, dur, repeat, "replace"));
        }
        "scale" => {
            let from = anim.get("from").and_then(|v| v.as_str()).unwrap_or("1 1");
            let to = anim.get("to").and_then(|v| v.as_str()).unwrap_or("2 2");
            anims.push(smil_animate_transform("scale", from, to, dur, repeat, "replace"));
        }
        "color_cycle" => {
            let attr = anim.get("attr").and_then(|v| v.as_str()).unwrap_or("fill");
            let from = anim.get("from").and_then(|v| v.as_str()).unwrap_or("#ff0000");
        ...
        _ => {
            ...
            let attr = anim.get("attr").and_then(|v| v.as_str()).unwrap_or("opacity");
...
fn parse_element(elem: &Value) -> Option<SvgElement> {
    ...
    let mut el = match shape {
        "rect" => {
            ...
            let fill = elem.get("fill").and_then(|v| v.as_str()).unwrap_or("#4A90E2");
            let stroke = elem.get("stroke").and_then(|v| v.as_str()).unwrap_or("none");
            let stroke_w = elem.get("stroke_width").and_then(|v| v.as_str()).unwrap_or("1");
        ...
        "circle" => {
            ...
            let fill = elem.get("fill").and_then(|v| v.as_str()).unwrap_or("#E74C3C");
            let stroke = elem.get("stroke").and_then(|v| v.as_str()).unwrap_or("none");
            let stroke_w = elem.get("stroke_width").and_then(|v| v.as_str()).unwrap_or("1");
            let opacity = elem.get("opacity").and_then(|v| v.as_str()).unwrap_or("1");
        ...
        "ellipse" => {
            ...
            let fill = elem.get("fill").and_then(|v| v.as_str()).unwrap_or("#9B59B6");
            let opacity = elem.get("opacity").and_then(|v| v.as_str()).unwrap_or("1");
        ...
        "line" => {
            ...
            let stroke = elem.get("stroke").and_then(|v| v.as_str()).unwrap_or("#2C3E50");
            let stroke_w = elem.get("stroke_width").and_then(|v| v.as_str()).unwrap_or("2");
            SvgElement::new("line")
                .attr("x1", x1)
                .attr("y1", y1)
                .attr("x2", x2)
        ...
        "polyline" => {
            ...
            let stroke = elem.get("stroke").and_then(|v| v.as_str()).unwrap_or("#1ABC9C");
            let stroke_w = elem.get("stroke_width").and_then(|v| v.as_str()).unwrap_or("2");
        ...
        "polygon" => {
            ...
            let fill = elem.get("fill").and_then(|v| v.as_str()).unwrap_or("#F39C12");
            let stroke = elem.get("stroke").and_then(|v| v.as_str()).unwrap_or("none");
            let stroke_w = elem.get("stroke_width").and_then(|v| v.as_str()).unwrap_or("1");
        ...
        "path" => {
            ...
            let fill = elem.get("fill").and_then(|v| v.as_str()).unwrap_or("none");
            let stroke = elem.get("stroke").and_then(|v| v.as_str()).unwrap_or("#E74C3C");
            let stroke_w = elem.get("stroke_width").and_then(|v| v.as_str()).unwrap_or("3");
            let opacity = elem.get("opacity").and_then(|v| v.as_str()).unwrap_or("1");
            // For stroke-dash draw-on effects, allow stroke-dasharray
            let dash = elem.get("stroke_dasharray").and_then(|v| v.as_str()).unwrap_or("");
            let dash_offset = elem.get("stroke_dashoffset").and_then(|v| v.as_str()).unwrap_or("");
        ...
        "text" => {
            ...
            let content = elem.get("content").and_then(|v| v.as_str()).unwrap_or("Hello");
            let font_size = elem.get("font_size").and_then(|v| v.as_str()).unwrap_or("24");
            let font_family = elem
                .get("font_family")
                .and_then(|v| v.as_str())
                .unwrap_or("sans-serif");
            let fill = elem.get("fill").and_then(|v| v.as_str()).unwrap_or("#2C3E50");
        ...
        for def in defs {
            ...
            match def_type {
                "linearGradient" => {
                    ...
                    let _ = writeln!(defs_content, "    <linearGradient id=\"{}\" x1=\"{}\" y1=\"{}\" x2=\"{}\" y2=\"{}\">", id, x1, y1, x2, y2);
                    if let Some(stops) = def.get("stops").and_then(|v| v.as_array()) {
                        for stop in stops {
                            let offset = stop.get("offset").and_then(|v| v.as_str()).unwrap_or("0%");
                            let color = stop.get("color").and_then(|v| v.as_str()).unwrap_or("#000");
                            let opacity = stop.get("opacity").and_then(|v| v.as_str()).unwrap_or("1");
                ...
                "radialGradient" => {
                    ...
                    let _ = writeln!(defs_content, "    <radialGradient id=\"{}\" cx=\"{}\" cy=\"{}\" r=\"{}\">", id, cx, cy, r);
                    if let Some(stops) = def.get("stops").and_then(|v| v.as_array()) {
                        for stop in stops {
                            let offset = stop.get("offset").and_then(|v| v.as_str()).unwrap_or("0%");
                            let color = stop.get("color").and_then(|v| v.as_str()).unwrap_or("#000");
                ...
                "filter" => {
                    ...
                    let filter_type = def.get("filter_type").and_then(|v| v.as_str()).unwrap_or("blur");
                    match filter_type {
                        "blur" => {
                            let std = def.get("stdDeviation").and_then(|v| v.as_str()).unwrap_or("3");
                        ...
                        "shadow" => {
                            ...
                            let color = def.get("color").and_then(|v| v.as_str()).unwrap_or("rgba(0,0,0,0.5)");
                ...
                "clipPath" => {
                    ...
                    match shape_def {
                        "rect" => {
                            ...
                            let _ = writeln!(defs_content, "      <rect x=\"{}\" y=\"{}\" width=\"{}\" height=\"{}\"/>", x, y, w, h);
                        }
                        "circle" => {
                            let cx = def.get("cx").and_then(|v| v.as_str()).unwrap_or("50");
                            let cy = def.get("cy").and_then(|v| v.as_str()).unwrap_or("50");
                            let r = def.get("r").and_then(|v| v.as_str()).unwrap_or("40");
                            let _ = writeln!(defs_content, "      <circle cx=\"{}\" cy=\"{}\" r=\"{}\"/>", cx, cy, r);
                        }
                        _ => {}
                    }
...
impl Tool for SvgAnimatorTool {
    ...
    async fn call(&self, arguments: &Value) -> Result<Value> {
        ...
        let svg_content = build_svg_document(arguments)
            .map_err(|e| anyhow!("SVG generation failed: {}", e))?;
