...
pub fn convert_with_password(
    ...
    match (ext.as_str(), target_format) {
        ...
        _ => {
            let doc = crate::tools::opendoc::handlers::load_to_ir_with_password(source, password)
...
fn pptx_to_markdown(source: &str, output: &str) -> Result<ConversionResult, ConversionError> {
    let md = crate::tools::opendoc::handlers::pptx::to_markdown(source);
...
fn pptx_to_pdf(source: &str, output: &str) -> Result<ConversionResult, ConversionError> {
    ...
    let doc = crate::tools::opendoc::handlers::pptx::to_ir(source)
        .map_err(|e| ConversionError::ConversionFailed(e.to_string()))?;
...
pub fn export(
    ...
    match target_format {
        ...
        "xlsx" => {
            crate::tools::opendoc::handlers::xlsx::from_ir(doc, output)
