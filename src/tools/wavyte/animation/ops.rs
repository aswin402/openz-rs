use crate::tools::wavyte::animation::anim::{Anim, Expr, LoopMode};
...
pub fn sequence(a: Anim<f64>, a_len: u64, b: Anim<f64>) -> Anim<f64> {
    ...
    let t_step = Anim::Keyframes(crate::tools::wavyte::animation::anim::Keyframes {
        keys: vec![
            crate::tools::wavyte::animation::anim::Keyframe {
                frame: crate::tools::wavyte::foundation::core::FrameIndex(0),
                value: 0.0,
                ease: crate::tools::wavyte::animation::ease::Ease::Linear,
            },
            crate::tools::wavyte::animation::anim::Keyframe {
                frame: crate::tools::wavyte::foundation::core::FrameIndex(a_len),
                value: 1.0,
                ease: crate::tools::wavyte::animation::ease::Ease::Linear,
            },
        ],
        mode: crate::tools::wavyte::animation::anim::InterpMode::Hold,
        default: None,
    });
