use super::*;
use crate::tools::wavyte::{Anim, Asset, Canvas, Clip, ClipProps, FrameIndex, FrameRange, PathAsset, Track};
...
fn comp_for_layout(mode: LayoutMode) -> Composition {
    ...
    Composition {
        ...
        tracks: vec![Track {
            ...
            layout_align_y: crate::tools::wavyte::LayoutAlignY::Center,
            ...
            clips: vec![
                Clip {
                    ...
                    props: ClipProps {
                        ...
                        blend: crate::tools::wavyte::BlendMode::Normal,
                    },
                    z_offset: 0,
                    effects: vec![],
                    transition_in: None,
