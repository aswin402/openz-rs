...
fn execute_plan_calls_in_expected_order() {
    let plan = RenderPlan {
        ...
        passes: vec![
            ...
            Pass::Offscreen(OffscreenPass {
                input: SurfaceId(1),
                output: SurfaceId(1),
                fx: crate::tools::wavyte::effects::fx::PassFx::Blur {
                    radius_px: 0,
                    sigma: 1.0,
                },
            }),
    ...
    let comp = crate::tools::wavyte::Composition {
        fps: crate::tools::wavyte::Fps::new(30, 1).unwrap(),
        canvas: crate::tools::wavyte::Canvas {
            width: 1,
            height: 1,
        },
        duration: crate::tools::wavyte::FrameIndex(1),
...
fn execute_plan_returns_final_frame() {
    let plan = RenderPlan {
        ...
        passes: vec![Pass::Scene(ScenePass {
            target: SurfaceId(0),
            ops: vec![crate::tools::wavyte::compile::DrawOp::FillPath {
                path: crate::tools::wavyte::foundation::core::BezPath::new(),
                transform: crate::tools::wavyte::foundation::core::Affine::IDENTITY,
                color: Rgba8Premul::from_straight_rgba(0, 0, 0, 0),
                opacity: 1.0,
                blend: crate::tools::wavyte::composition::model::BlendMode::Normal,
                z: 0,
            }],
            clear_to_transparent: true,
        })],
