...
///
/// Most users do not call [`RenderBackend::render_plan`] directly; prefer [`crate::tools::wavyte::render_frame`]
...
pub fn create_backend(
    ...
    match kind {
        BackendKind::Cpu => Ok(Box::new(crate::tools::wavyte::render::cpu::CpuBackend::new(
            _settings.clone(),
        ))),
    }
}
