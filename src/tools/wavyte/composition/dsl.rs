...
/// Builder for [`Composition`](crate::tools::wavyte::Composition).
pub struct CompositionBuilder {
    fps: crate::tools::wavyte::foundation::core::Fps,
    canvas: Canvas,
    duration: FrameIndex,
    seed: u64,
...
impl CompositionBuilder {
    ...
    pub fn new(fps: crate::tools::wavyte::foundation::core::Fps, canvas: Canvas, duration: FrameIndex) -> Self {
        Self {
            fps,
            canvas,
            duration,
    ...
    /// Convenience helper to add a [`VideoAsset`](crate::tools::wavyte::VideoAsset).
    pub fn video_asset(
        self,
    ...
    /// Convenience helper to add an [`AudioAsset`](crate::tools::wavyte::AudioAsset).
    pub fn audio_asset(
        self,
        key: impl Into<String>,
        source: impl Into<String>,
    ...
    /// Build and validate final [`Composition`](crate::tools::wavyte::Composition).
...
/// Builder for [`Track`](crate::tools::wavyte::Track) values.
pub struct TrackBuilder {
    name: String,
    z_base: i32,
    layout_mode: crate::tools::wavyte::LayoutMode,
    layout_gap_px: f64,
    layout_padding: crate::tools::wavyte::Edges,
    layout_align_x: crate::tools::wavyte::LayoutAlignX,
    layout_align_y: crate::tools::wavyte::LayoutAlignY,
...
impl TrackBuilder {
    ...
    pub fn layout_mode(mut self, mode: crate::tools::wavyte::LayoutMode) -> Self {
    ...
    pub fn layout_padding(mut self, padding: crate::tools::wavyte::Edges) -> Self {
        self.layout_padding = padding;
        self
    }

    /// Set horizontal and vertical alignment for layout placement.
    pub fn layout_align(mut self, x: crate::tools::wavyte::LayoutAlignX, y: crate::tools::wavyte::LayoutAlignY) -> Self {
    ...
    /// Build validated [`Track`](crate::tools::wavyte::Track).
...
/// Builder for [`Clip`](crate::tools::wavyte::Clip) values.
...
impl ClipBuilder {
    ...
    /// Build validated [`Clip`](crate::tools::wavyte::Clip).
