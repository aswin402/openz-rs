use crate::tools::wavyte::effects::transitions::WipeDir;
use crate::tools::wavyte::foundation::error::WavyteResult;
use crate::tools::wavyte::foundation::math::mul_div255_u8;
...
pub fn over_in_place(dst: &mut [u8], src: &[u8], opacity: f32) -> WavyteResult<()> {
    if dst.len() != src.len() || !dst.len().is_multiple_of(4) {
        return Err(crate::tools::wavyte::WavyteError::evaluation(
...
pub fn wipe_over_in_place(
    ...
    let expected_len = (width as usize)
        ...
        .ok_or_else(|| crate::tools::wavyte::WavyteError::evaluation("wipe buffer size overflow"))?;
