use crate::tools::wavyte::foundation::error::{WavyteError, WavyteResult};

#[derive(Clone, Copy, Debug, PartialEq, Eq, Hash)]
pub struct SvgRasterKey {
    pub asset: crate::tools::wavyte::assets::store::AssetId,
    pub width: u32,
    pub height: u32,
}
...
pub fn svg_raster_params(
...
) -> WavyteResult<(u32, u32, crate::tools::wavyte::foundation::core::Affine)> {
    ...
    let inv = crate::tools::wavyte::foundation::core::Affine::scale_non_uniform(1.0 / sx, 1.0 / sy);
