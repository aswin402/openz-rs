...
//! ## Core concepts
//!
//! - [`Composition`](crate::tools::wavyte::Composition): the timeline (assets + tracks + clips) and global settings
//! - [`FrameIndex`](crate::tools::wavyte::FrameIndex): a 0-based frame index within the composition’s duration
//! - [`Evaluator`](crate::tools::wavyte::Evaluator): resolves what is visible at a frame and in what order
//! - [`RenderPlan`](crate::tools::wavyte::RenderPlan): backend-agnostic render IR for a single frame
//! - [`RenderBackend`](crate::tools::wavyte::RenderBackend): executes a plan into pixels
//! - [`FrameRGBA`](crate::tools::wavyte::FrameRGBA): the output pixels (RGBA8, premultiplied alpha)
//! - [`PreparedAssetStore`](crate::tools::wavyte::PreparedAssetStore): immutable prepared assets loaded up front
//!
//! The rendering pipeline is explicitly staged:
//!
//! 1. Evaluate timeline visibility: [`Evaluator::eval_frame`](crate::tools::wavyte::Evaluator::eval_frame)
//! 2. Compile into passes: [`compile_frame`](crate::tools::wavyte::compile_frame)
//! 3. Execute passes: [`RenderBackend::render_plan`](crate::tools::wavyte::RenderBackend::render_plan)
//!
//! Convenience wrappers for step (1)+(2)+(3) live in:
//! - [`render_frame`](crate::tools::wavyte::render_frame)
//! - [`render_frames`](crate::tools::wavyte::render_frames)
//! - [`render_to_mp4`](crate::tools::wavyte::render_to_mp4)
//!
//! ---
//!
...
//! Instead:
//!
//! - IO and decoding happen through [`PreparedAssetStore::prepare`](crate::tools::wavyte::PreparedAssetStore::prepare)
//! - Renderers consume **prepared** assets:
//!   - [`PreparedImage`](crate::tools::wavyte::PreparedImage) (premultiplied RGBA8)
//!   - [`PreparedSvg`](crate::tools::wavyte::PreparedSvg) (`usvg::Tree`)
//!   - [`PreparedText`](crate::tools::wavyte::PreparedText) (Parley layout + font bytes)
//!
//! Assets are loaded from a root directory via [`PreparedAssetStore::prepare`](crate::tools::wavyte::PreparedAssetStore::prepare)
...
//! - render backends output premultiplied pixels in [`FrameRGBA`](crate::tools::wavyte::FrameRGBA)
...
//! timeline fields are modeled as animated values ([`Anim<T>`](crate::tools::wavyte::Anim)).
...
//! Notes:
//!
//! - [`Composition::validate`](crate::tools::wavyte::Composition::validate) is called by the builder.
//! - The example uses [`Anim::constant`](crate::tools::wavyte::Anim::constant) to avoid verbose keyframes.
//!
//! ---
//!
...
//!
//! [`Evaluator`](crate::tools::wavyte::Evaluator) converts a `Composition` into an [`EvaluatedGraph`](crate::tools::wavyte::EvaluatedGraph)
//! at a given frame index:
//!
//! - clips are filtered by their [`FrameRange`](crate::tools::wavyte::FrameRange)
//! - animated properties are sampled ([`Anim::sample`](crate::tools::wavyte::Anim::sample))
//! - transforms are resolved into a `kurbo::Affine` (re-exported as [`Affine`](crate::tools::wavyte::Affine))
...
//!
//! - [`ScenePass`](crate::tools::wavyte::ScenePass)
//! - [`OffscreenPass`](crate::tools::wavyte::OffscreenPass) (currently used for blur)
//! - [`CompositePass`](crate::tools::wavyte::CompositePass) (`Over`, `Crossfade`, `Wipe`)
//!
//! ### Draw operations and coordinate conventions
//!
//! Each [`DrawOp`](crate::tools::wavyte::DrawOp) carries:
//!
//! - a [`Affine`](crate::tools::wavyte::Affine) transform
//! - an opacity factor in `[0, 1]`
//! - a blend mode (currently only [`BlendMode::Normal`](crate::tools::wavyte::BlendMode))
//! - an integer `z` used for ordering within a pass
//!
//! v0.2.1 draw ops:
//!
//! - `FillPath`:
//!   - the local coordinate space is the SVG path coordinates parsed into a [`BezPath`](crate::tools::wavyte::BezPath)
...
//!   - pass effects (implemented as an [`OffscreenPass`](crate::tools::wavyte::OffscreenPass))
//!   - currently implemented pass effect: blur
//! - Transitions:
//!   - crossfade
//!   - wipe (direction + soft edge)
//!
//! Transitions are compiled into [`CompositePass`](crate::tools::wavyte::CompositePass) operations rather than
...
//!
//! A renderer implements [`RenderBackend`](crate::tools::wavyte::RenderBackend), which extends
//! [`PassBackend`](crate::tools::wavyte::PassBackend) (the trait that knows how to execute individual passes).
//!
//! Backend construction is done via:
//!
//! - [`BackendKind`](crate::tools::wavyte::BackendKind): `Cpu`
//! - [`create_backend`](crate::tools::wavyte::create_backend): returns `Box<dyn RenderBackend>`
//!
...
//!
//! Parallel rendering is available via [`RenderThreading`](crate::tools::wavyte::RenderThreading), including
//! optional static-frame elision using [`FrameFingerprint`](crate::tools::wavyte::FrameFingerprint) to skip
...
//! binary:
//!
//! - [`FfmpegEncoder`](crate::tools::wavyte::FfmpegEncoder) spawns `ffmpeg` and streams raw frames to stdin
//! - [`render_to_mp4`](crate::tools::wavyte::render_to_mp4) orchestrates frame rendering and feeding the encoder
//!
...
//!
//! - [`EncodeConfig`](crate::tools::wavyte::EncodeConfig)
//! - [`default_mp4_config`](crate::tools::wavyte::default_mp4_config)
//!
