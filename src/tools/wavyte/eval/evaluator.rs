...
impl Evaluator {
    ...
    pub fn eval_frame(comp: &Composition, frame: FrameIndex) -> WavyteResult<EvaluatedGraph> {
        Self::eval_frame_with_layout_impl(comp, frame, &crate::tools::wavyte::LayoutOffsets::default(), true)
    }
    ...
    pub fn eval_frame_with_layout(
        comp: &Composition,
        frame: FrameIndex,
        layout: &crate::tools::wavyte::LayoutOffsets,
...
fn eval_clip(
    ...
    frame: FrameIndex,
    track_z_base: i32,
    layout_offset: crate::tools::wavyte::foundation::core::Vec2,
    ...
    let source_time_s = match comp.assets.get(&clip.asset) {
        Some(Asset::Video(video)) => Some(crate::tools::wavyte::assets::media::video_source_time_sec(
            video,
            clip_local.0,
            comp.fps,
        )),
