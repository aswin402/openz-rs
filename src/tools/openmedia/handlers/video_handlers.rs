...
use crate::tools::openmedia::video::{FrameRenderer, SceneElement, VideoScene};
impl OpenMediaServer {
    pub async fn video_create(
        ...
        let video_spec = crate::tools::openmedia::video::render_video_scene(&scene, &output_path)
            .await
    ...
    pub async fn video_preview(
        ...
        let frame = if use_browser {
            let renderer = crate::tools::openmedia::video::BrowserFrameRenderer::launch()
                .await
                .map_err(|e| e.to_string())?;
            let f = renderer
            ...
            let renderer = crate::tools::openmedia::video::SvgFrameRenderer;
            renderer
                .render_frame(&scene, t, w, h)
                .await
                .map_err(|e| e.to_string())?
        ...
        let file_size = std::fs::metadata(&output_path)
            .map(|m| m.len())
            .unwrap_or(0);
        let output = crate::tools::openmedia::core::ImageOutput {
            path: output_path,
            width: w,
            height: h,
            seed: 0,
    ...
    pub async fn video_create_slideshow(
        &self,
        req: VideoCreateSlideshowRequest,
    ) -> Result<serde_json::Value, String> {
        ...
        for (i, img_src) in resolved_images.iter().enumerate() {
            ...
            let element = crate::tools::openmedia::video::SceneElement::Image {
                src: img_src.clone(),
                position: crate::tools::openmedia::video::Position {
                    x: crate::tools::openmedia::video::DimensionValue::Pixels(0.0),
                    y: crate::tools::openmedia::video::DimensionValue::Pixels(0.0),
                },
                size: crate::tools::openmedia::video::Size {
                    width: crate::tools::openmedia::video::DimensionValue::Percentage("100%".to_string()),
                    height: crate::tools::openmedia::video::DimensionValue::Percentage("100%".to_string()),
                },
                fit: crate::tools::openmedia::video::ObjectFit::Contain,
                timeline: None,
            };

            scenes.push(crate::tools::openmedia::video::Scene {
                id: scene_id.clone(),
                start,
                end,
            ...
            if i > 0 {
                ...
                transitions.push(crate::tools::openmedia::video::SceneTransition {
                    from,
                    to,
                    transition_type,
        ...
        let audio = req.audio_src.map(|src| crate::tools::openmedia::video::AudioConfig {
        ...
        let scene = crate::tools::openmedia::video::VideoScene {
            width,
            height,
            fps,
    ...
    pub async fn video_add_transition(
        ...
        scene.transitions.push(crate::tools::openmedia::video::SceneTransition {
    ...
    pub async fn video_add_audio(
        ...
        if target.is_file() && req.target_path.ends_with(".json") {
            ...
            let track = crate::tools::openmedia::video::AudioTrack {
                src: req.audio_path,
                start: start_time,
                volume,
                fade_in: req.fade_in,
            ...
            if let Some(audio_cfg) = &mut scene.audio {
                ...
                scene.audio = Some(crate::tools::openmedia::video::AudioConfig {
                    tracks: vec![track],
                });
            }
        ...
        let file_size = std::fs::metadata(&output_path)
            .map(|m| m.len())
            .unwrap_or(0);
        let output = crate::tools::openmedia::core::VideoSpec {
            path: output_path,
            width: 0,
            height: 0,
            duration: 0.0,
    ...
    pub async fn video_from_template(
        &self,
        mut req: VideoFromTemplateRequest,
    ) -> Result<serde_json::Value, String> {
        ...
        let scene = match req.template_name.to_lowercase().as_str() {
            "slideshow" => {
                ...
                for (i, img_src) in images.iter().enumerate() {
                    scenes.push(crate::tools::openmedia::video::Scene {
                        ...
                        elements: vec![crate::tools::openmedia::video::SceneElement::Image {
                            src: img_src.clone(),
                            position: crate::tools::openmedia::video::Position {
                                x: crate::tools::openmedia::video::DimensionValue::Pixels(0.0),
                                y: crate::tools::openmedia::video::DimensionValue::Pixels(0.0),
                            ...
                            size: crate::tools::openmedia::video::Size {
                                width: crate::tools::openmedia::video::DimensionValue::Percentage(
                                    "100%".to_string(),
                                ),
                                height: crate::tools::openmedia::video::DimensionValue::Percentage(
                                    "100%".to_string(),
                                ),
                            },
                            fit: crate::tools::openmedia::video::ObjectFit::Contain,
                ...
                if images.len() > 1 && req.parameters.get("transition_type").is_some() {
                    let (custom_trans_type, custom_duration, custom_easing) =
                        parse_transition_params(
                            &req.parameters,
                            crate::tools::openmedia::video::TransitionType::Crossfade,
                        );
                ...
                crate::tools::openmedia::video::VideoScene {
                    width,
                    height,
                    fps,
            ...
            "text_explainer" => {
                ...
                let s0_elements = vec![crate::tools::openmedia::video::SceneElement::Text {
                    content: title.clone(),
                    style: crate::tools::openmedia::video::TextStyle {
                    ...
                    position: crate::tools::openmedia::video::Position {
                        x: crate::tools::openmedia::video::DimensionValue::Pixels((width / 2) as f64),
                        y: crate::tools::openmedia::video::DimensionValue::Pixels(150.0),
                    },
                    anchor: crate::tools::openmedia::video::Anchor::Center,
                    timeline: None,
                }];
                scenes.push(crate::tools::openmedia::video::Scene {
                ...
                for i in 0..bullets.len() {
                    ...
                    for (j, bullet_text) in bullets.iter().enumerate().take(i + 1) {
                        el.push(crate::tools::openmedia::video::SceneElement::Text {
                            ...
                            position: crate::tools::openmedia::video::Position {
                                x: crate::tools::openmedia::video::DimensionValue::Pixels(200.0),
                                y: crate::tools::openmedia::video::DimensionValue::Pixels(300.0 + j as f64 * 80.0),
                            },
                            anchor: crate::tools::openmedia::video::Anchor::TopLeft,
                            timeline: None,
                        });
                    }
                    scenes.push(crate::tools::openmedia::video::Scene {
            ...
            "data_dashboard" => {
                ...
                scenes.push(crate::tools::openmedia::video::Scene {
                    ...
                    elements: vec![crate::tools::openmedia::video::SceneElement::Text {
                        content: title.clone(),
                        style: crate::tools::openmedia::video::TextStyle {
                            font_family: "sans-serif".to_string(),
                            font_size: 64.0,
                        ...
                        position: crate::tools::openmedia::video::Position {
                            x: crate::tools::openmedia::video::DimensionValue::Pixels((width / 2) as f64),
                            y: crate::tools::openmedia::video::DimensionValue::Pixels((height / 2) as f64),
                        },
                        anchor: crate::tools::openmedia::video::Anchor::Center,
                        timeline: None,
                    }],
                ...
                let (custom_trans_type, custom_duration, custom_easing) = parse_transition_params(
                    &req.parameters,
                    crate::tools::openmedia::video::TransitionType::SlideLeft,
                );
                ...
                for (i, chart_val) in charts_arr.iter().enumerate() {
                    ...
                    scenes.push(crate::tools::openmedia::video::Scene {
                        ...
                        elements: vec![
                            crate::tools::openmedia::video::SceneElement::Text {
                                content: chart_title,
                                style: crate::tools::openmedia::video::TextStyle {
                                    font_family: "sans-serif".to_string(),
                                    font_size: 40.0,
                                ...
                                position: crate::tools::openmedia::video::Position {
                                    x: crate::tools::openmedia::video::DimensionValue::Pixels((width / 2) as f64),
                                    y: crate::tools::openmedia::video::DimensionValue::Pixels(80.0),
                                },
                                anchor: crate::tools::openmedia::video::Anchor::Center,
                                timeline: None,
                            },
                            crate::tools::openmedia::video::SceneElement::Chart {
                                chart_type,
                                data: chart_data,
                                position: crate::tools::openmedia::video::Position {
                                    x: crate::tools::openmedia::video::DimensionValue::Pixels((width / 2) as f64),
                                    y: crate::tools::openmedia::video::DimensionValue::Pixels(
                                        (height / 2 + 30) as f64,
                                    ),
                                },
                                size: crate::tools::openmedia::video::Size {
                                    width: crate::tools::openmedia::video::DimensionValue::Pixels(
                                        (width - 400) as f64,
                                    ),
                                    height: crate::tools::openmedia::video::DimensionValue::Pixels(
                                        (height - 300) as f64,
                                    ),
                                },
            ...
            "social_media" => {
                ...
                scenes.push(crate::tools::openmedia::video::Scene {
                    ...
                    elements: vec![crate::tools::openmedia::video::SceneElement::Text {
                        ...
                        anchor: crate::tools::openmedia::video::Anchor::Center,
                        timeline: Some(crate::tools::openmedia::video::ElementTimeline {
                            keyframes: vec![
                                crate::tools::openmedia::video::Keyframe {
                                    time: 0.0,
                                    opacity: Some(0.0),
                                    x: None,
                                    y: None,
                ...
                let (custom_trans_type, custom_duration, custom_easing) = parse_transition_params(
                    &req.parameters,
                    crate::tools::openmedia::video::TransitionType::SlideUp,
                );
                ...
                for (i, content_val) in content_arr.iter().enumerate() {
                    ...
                    scenes.push(crate::tools::openmedia::video::Scene {
                        ...
                        elements: vec![
                            ...
                            crate::tools::openmedia::video::SceneElement::Shape {
                                shape: crate::tools::openmedia::video::ShapeType::Circle,
                                size: crate::tools::openmedia::video::Size {
                                    width: crate::tools::openmedia::video::DimensionValue::Pixels(350.0),
                                    height: crate::tools::openmedia::video::DimensionValue::Pixels(350.0),
                                },
                                position: crate::tools::openmedia::video::Position {
                                    x: crate::tools::openmedia::video::DimensionValue::Pixels(100.0),
                                    y: crate::tools::openmedia::video::DimensionValue::Pixels(300.0),
                                },
                                style: crate::tools::openmedia::video::ShapeStyle {
                            ...
                            crate::tools::openmedia::video::SceneElement::Shape {
                                shape: crate::tools::openmedia::video::ShapeType::Circle,
                                size: crate::tools::openmedia::video::Size {
                                    width: crate::tools::openmedia::video::DimensionValue::Pixels(450.0),
                                    height: crate::tools::openmedia::video::DimensionValue::Pixels(450.0),
                                },
                                position: crate::tools::openmedia::video::Position {
                                    x: crate::tools::openmedia::video::DimensionValue::Pixels(800.0),
                                    y: crate::tools::openmedia::video::DimensionValue::Pixels(1400.0),
                                },
                                style: crate::tools::openmedia::video::ShapeStyle {
                            ...
                            // Card Container
                            crate::tools::openmedia::video::SceneElement::Shape {
                                shape: crate::tools::openmedia::video::ShapeType::RoundedRect,
                                size: crate::tools::openmedia::video::Size {
                                    width: crate::tools::openmedia::video::DimensionValue::Pixels(920.0),
                                    height: crate::tools::openmedia::video::DimensionValue::Pixels(1000.0),
                                },
                                position: crate::tools::openmedia::video::Position {
                                    x: crate::tools::openmedia::video::DimensionValue::Pixels(80.0),
                                    y: crate::tools::openmedia::video::DimensionValue::Pixels(460.0),
                                },
                                style: crate::tools::openmedia::video::ShapeStyle {
                            ...
                            crate::tools::openmedia::video::SceneElement::Text {
                                ...
                                position: crate::tools::openmedia::video::Position {
                                    x: crate::tools::openmedia::video::DimensionValue::Pixels((width / 2) as f64),
                                    y: crate::tools::openmedia::video::DimensionValue::Pixels(580.0),
                                },
                                anchor: crate::tools::openmedia::video::Anchor::Center,
                                timeline: Some(crate::tools::openmedia::video::ElementTimeline {
                                    keyframes: vec![
            ...
            "product_showcase" => {
                ...
                scenes.push(crate::tools::openmedia::video::Scene {
                    ...
                    elements: vec![
                        ...
                        crate::tools::openmedia::video::SceneElement::Image {
                            src: image_src.clone(),
                            position: crate::tools::openmedia::video::Position {
                                x: crate::tools::openmedia::video::DimensionValue::Pixels((width / 2) as f64),
                                y: crate::tools::openmedia::video::DimensionValue::Pixels(
                            ...
                            size: crate::tools::openmedia::video::Size {
                                width: crate::tools::openmedia::video::DimensionValue::Pixels(600.0),
                                height: crate::tools::openmedia::video::DimensionValue::Pixels(450.0),
                            },
                            fit: crate::tools::openmedia::video::ObjectFit::Contain,
                            timeline: Some(crate::tools::openmedia::video::ElementTimeline {
                    ...
                    scenes.push(crate::tools::openmedia::video::Scene {
                        ...
                        elements: vec![
                            crate::tools::openmedia::video::SceneElement::Text {
                                ...
                                position: crate::tools::openmedia::video::Position {
                                    x: crate::tools::openmedia::video::DimensionValue::Pixels(150.0),
                                    y: crate::tools::openmedia::video::DimensionValue::Pixels(100.0),
                                },
                                anchor: crate::tools::openmedia::video::Anchor::TopLeft,
                                timeline: None,
                            },
                            crate::tools::openmedia::video::SceneElement::Image {
                                src: image_src.clone(),
                                position: crate::tools::openmedia::video::Position {
                                    x: crate::tools::openmedia::video::DimensionValue::Pixels(450.0),
                                    y: crate::tools::openmedia::video::DimensionValue::Pixels((height / 2) as f64),
                                },
                                size: crate::tools::openmedia::video::Size {
                                    width: crate::tools::openmedia::video::DimensionValue::Pixels(600.0),
                            ...
                            crate::tools::openmedia::video::SceneElement::Text {
                                ...
                                position: crate::tools::openmedia::video::Position {
                                    x: crate::tools::openmedia::video::DimensionValue::Pixels(
                                        (width / 2 + 100) as f64,
                                    ),
                                    y: crate::tools::openmedia::video::DimensionValue::Pixels((height / 2) as f64),
                                },
                                anchor: crate::tools::openmedia::video::Anchor::CenterLeft,
                                timeline: Some(crate::tools::openmedia::video::ElementTimeline {
                                    keyframes: vec![
                                        crate::tools::openmedia::video::Keyframe {
                                            time: 0.0,
            ...
            _ => {
                ...
                if template_path.exists() && template_path.is_file() {
                    ...
                    let scene: crate::tools::openmedia::video::VideoScene = serde_json::from_value(interpolated)
                        .map_err(|e| {
                    ...
                    crate::tools::openmedia::video::VideoScene {
                        ...
                        scenes: vec![crate::tools::openmedia::video::Scene {
                            id: "scene_0".to_string(),
                            start: 0.0,
                            end: 3.0,
                            elements: vec![crate::tools::openmedia::video::SceneElement::Text {
        ...
        for (i, offset) in req.offsets.iter().enumerate() {
            ...
            if output_path.exists() {
                ...
                let file_size = std::fs::metadata(&output_path)
                    .map(|m| m.len())
                    .unwrap_or(0);
                outputs.push(crate::tools::openmedia::core::ImageOutput {
                    path: output_path,
                    width: w,
                    height: h,
                    seed: 0,
    ...
    pub async fn video_trim(
        ...
        let file_size = std::fs::metadata(&output_path)
            .map(|m| m.len())
            .unwrap_or(0);
        let spec = crate::tools::openmedia::core::VideoSpec {
            path: output_path,
            width: 0,
            height: 0,
            duration,
