...
const MAX_WS_MESSAGE_SIZE: usize = 40 * 1024 * 1024; // base64 envelope for the aggregate attachment quota
...
fn attachment_mime_allowed(mime: &str) -> bool {
...
fn sanitize_attachment_name(raw_name: &str) -> Option<String> {
